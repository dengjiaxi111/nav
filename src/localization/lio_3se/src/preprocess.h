...
//   EIGEN_MAKE_ALIGNED_OPERATOR_NEW
  ...
  void process_multi(const livox_ros_driver2::msg::CustomMsg::ConstSharedPtr &msg1,const livox_ros_driver2::msg::CustomMsg::ConstSharedPtr &msg2, PointCloudXYZI::Ptr& pcl_out);
...
private:
  ...
  void avia_handler_multi(const livox_ros_driver2::msg::CustomMsg::ConstSharedPtr &msg1, const livox_ros_driver2::msg::CustomMsg::ConstSharedPtr &msg2);
