...
IntegrationComponent::IntegrationComponent(const rclcpp::NodeOptions& options)
    ...
    std::vector<std::string> projector_param_names = {
        ...
        "high_occupancy_thresh", "keep_step_cells",
        "enable_obstacle_support_filter", "obstacle_support_radius_cells",
        "obstacle_min_support_count", "obstacle_support_max_height",
        "normal_z_slope_thresh", "normal_z_wall_thresh",
