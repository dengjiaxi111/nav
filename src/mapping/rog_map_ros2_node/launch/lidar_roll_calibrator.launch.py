...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument("current_roll", default_value="0.529883"),
        ...
        DeclareLaunchArgument("candidate_base_z_min", default_value="-1.0"),
        DeclareLaunchArgument("candidate_base_z_max", default_value="0.25"),
        DeclareLaunchArgument("min_candidates", default_value="3000"),
        Node(
            package="rog_map_ros2_node",
            executable="lidar_roll_calibrator",
            name="lidar_roll_calibrator",
            output="screen",
            parameters=[{
