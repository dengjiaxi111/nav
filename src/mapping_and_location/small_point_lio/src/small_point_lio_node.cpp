...
namespace small_point_lio {
    ...
    SmallPointLioNode::SmallPointLioNode(const rclcpp::NodeOptions &options)
        ...
        small_point_lio->set_odometry_callback([this, lidar_frame](const common::Odometry &odometry) {
            ...
            // base_link_static发布
            tf2::Transform tf_base_to_base_static;
            tf_base_to_base_static.setOrigin(tf2::Vector3(0, 0, 0));
            tf_base_to_base_static.setRotation(tf2::Quaternion(q_base_in_odom.x(), q_base_in_odom.y(), q_base_in_odom.z(), q_base_in_odom.w()));
            ...
            tf2::Quaternion q;
            q.setRPY(0,0,-tf2::getYaw(transform_stamped.transform.rotation));
